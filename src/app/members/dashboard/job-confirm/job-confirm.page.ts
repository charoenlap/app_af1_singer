...
export class JobConfirmPage implements OnInit {
  ...
  async savePad() {
    ...
    formData.append('kycNo',this.kycNo);
    ...
    await this.api.confirmJob(formData,this.route.snapshot.paramMap.get('id'),this.objVal,this.comment,this.kycNo).subscribe(res => {
        // console.log('>');
